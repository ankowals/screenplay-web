 ...
 * enabled we have a single instance shared for all com.github.ankowals.tests. To run test configure
 * parallel execution so that top-level classes run in parallel but methods in same thread.
 *
